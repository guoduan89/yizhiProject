        ...
        <Form ref="formRef" :model="formValidate" :rules="ruleValidate" :label-width="120">
          ...
          <FormItem label="参赛教学团队资格" prop="interest">
            <CheckboxGroup v-model="formValidate.interest">
              <Checkbox label="1、团队每个成员教龄3年以上，近3年实际承担参赛课程或相关课程教学任务;" /><br />
              <Checkbox label="2、35 岁以下(含)的教师不少于1人或思政课(二选一)" /><br />
              <Checkbox label="3、具备高级专业技术职务或取得高级职业技能等级证书的教师不少于1人;" /><br />
              <Checkbox label="4、专业课程组的教学团队中“双师型”教师占比在50%以上;企业兼职教师数量不超过1名;(此项可选择答题，不是必选项)" /><br />
              <Checkbox label="5、近2年曾获得过全国职业院校技能大赛教学能力比赛一等奖的教学团队各成员不能报名参赛，其所有成员所在学校不能以同一公共基础课报名参加公共基础课程组，或不能以同一专业报名参加专业(技能)课程组的比赛:近2年曾获得国赛等奖的教学团队需要调整成员方能报名参赛(至多保留2名原成员，且必须有新成贝)。近2年获省赛奖励的作品，未作重大修改不得参赛。获得2022年某某市中笔职业学校教学能力比赛一等奖的作品，不能参赛，" /><br />
            </CheckboxGroup>
          </FormItem>
